      ...
      <div className="form-container mx-auto" style={{ maxWidth: '600px' }}>
        ...
        <form id="postEventForm">
          <div className="form-group">
            ...
            <input type="text" className="form-control" id="eventTitle" placeholder="Renginio Pavadinimas" required style={{ padding: '1rem', fontSize: '1rem', backgroundColor: '#000', color: '#fff' }} />
          </div>
          <div className="form-group">
            <label htmlFor="eventDate" style={{ fontSize: '1.2rem' }}>Data</label>
            <input type="date" className="form-control" id="eventDate" required style={{ padding: '1rem', fontSize: '1rem', backgroundColor: '#000', color: '#fff' }} />
          </div>
          <div className="form-group">
            <label htmlFor="eventTime" style={{ fontSize: '1.2rem' }}>Laikas</label>
            <input type="time" className="form-control" id="eventTime" required style={{ padding: '1rem', fontSize: '1rem', backgroundColor: '#000', color: '#fff' }} />
          </div>
          <div className="form-group">
            <label htmlFor="eventLocation" style={{ fontSize: '1.2rem' }}>Vieta</label>
            <input type="text" className="form-control" id="eventLocation" placeholder="Renginio Vieta" required style={{ padding: '1rem', fontSize: '1rem', backgroundColor: '#000', color: '#fff' }} />
          </div>
          <div className="form-group">
            <label htmlFor="eventCategory" style={{ fontSize: '1.2rem' }}>Kategorija</label>
            <select className="form-control" id="eventCategory" required style={{ padding: '1rem', fontSize: '1rem', backgroundColor: '#000', color: '#fff' }}>
